...
package builders.dsl.spreadsheet.onedrive.auth;
 ...
 */
public abstract class MSAAuthAdapter implements IAuthenticationAdapter {
     ...
     */
    public MSAAuthAdapter(final Application application) {
